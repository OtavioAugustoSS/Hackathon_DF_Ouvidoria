...
import ReportForm from './components/ReportForm'; // New Import
import { TipoManifestacao, Channel } from './types';

type ViewState = 'HOME' | 'CHANNEL_SELECTION' | 'REPORT_FORM';
        ...
        <div className="border-b border-gray-100">
          <div className="layout-container max-w-7xl mx-auto w-full px-4 md:px-8 h-20 flex items-center justify-between">
            ...
            <div className="flex gap-3">
              <button className="hidden sm:flex items-center justify-center h-10 px-6 bg-primary hover:bg-primary-dark text-white text-sm font-bold rounded-full transition-all shadow-sm gap-2">
